...
# and a lot of computation, we won't train it from scratch here. Instead, we load a previously trained model.
...
# of the model on the specified image.
database = {}
...
def verify(image_path, identity, database, model):
    ...
    # dist = tf.reduce_sum(tf.square(tf.subtract(encoding, database[identity])), axis=-1)
